...
ORDER BY grand_total_claims DESC
LIMIT 5;
--Nurse Practitioner with 900845 claims

--c.Are there any specialties that appear in the prescriber table that have no associated 
...
--Do not attempt until you have solved all other problems!* For each specialty, 
--report the percentage of total claims by that specialty which are for opioids. 
--Which specialties have a high percentage of opiods?
...
--b. Which drug (generic_name) has the hightest total cost per day? **Bonus: Round your cost per
--day column to 2 decimal places. Google ROUND to see how this works.
...
--($105,080,626.37 vs $38,435,121.26)
...
LIMIT 5;
--Biggest is Nashville-Davidson--Murfreesboro--Franklin, TN with pop of 1830410
...
---c. What is the largest (in terms of population) county which is not included in a CBSA? Report 
--the county name and population.
...
--Sevier County and a pop of 95523
...
--b. For each instance that you found in part a, add a column that indicates whether the drug
--is an opiod.
...
ORDER BY npi, drug_name;
-----
--c. Finally,COALESCE function is good/necessary.
SELECT 
	npi, 
	drug_name, 
